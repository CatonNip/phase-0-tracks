...
#STATE_DATA is a nested data structure that hashes within a hash.
#STATE_DATA is a constant which means it's kind of like a variable BUT it's value remains constant.
